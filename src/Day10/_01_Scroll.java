...
public class _01_Scroll extends BaseDriver {
    ...
    public void scrollTest(){
        ...
        WebElement imgWithOrange = driver.findElement(By.xpath("//img[@data-gallery-uid='205']"));
        MyMethods.myWait(2);
    ...
    public void javaScriptClickTest(){
        ...
        for(WebElement url : urls){ // clicks all links without mailto word in href attribute
