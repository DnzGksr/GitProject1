...
public class _04_FindByLinkText {
    public static void main(String[] args) {
        ...
        //we use it for a tag elements. Locates the elements by using their visible text
        ...
        System.out.println("careersLink.getAttribute(\"class\") = " + careersLink.getAttribute("class"));
            ...
            careersLink.click(); // click on the element
        ...
        if(!url1.equals(url2)){ // gets the current url on the browser
